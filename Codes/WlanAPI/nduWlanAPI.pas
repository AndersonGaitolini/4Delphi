...
const
  ...
  NDU_WLAN_REASON_CODE_AC_CONNECT_BASE = (NDU_WLAN_REASON_CODE_AC_BASE +
    NDU_WLAN_REASON_CODE_RANGE_SIZE div 2);

  NDU_WLAN_REASON_CODE_AC_END = (NDU_WLAN_REASON_CODE_AC_BASE +
    NDU_WLAN_REASON_CODE_RANGE_SIZE - 1);

  NDU_WLAN_REASON_CODE_PROFILE_BASE = NDU_L2_REASON_CODE_PROFILE_BASE;

  NDU_WLAN_REASON_CODE_PROFILE_CONNECT_BASE = (NDU_WLAN_REASON_CODE_PROFILE_BASE
    + NDU_WLAN_REASON_CODE_RANGE_SIZE div 2);

  NDU_WLAN_REASON_CODE_PROFILE_END = (NDU_WLAN_REASON_CODE_PROFILE_BASE +
    NDU_WLAN_REASON_CODE_RANGE_SIZE - 1);
  ...
  NDU_WLAN_REASON_CODE_MSM_END = (NDU_WLAN_REASON_CODE_MSM_BASE +
    NDU_WLAN_REASON_CODE_RANGE_SIZE - 1);
  ...
  NDU_WLAN_REASON_CODE_MSMSEC_END = (NDU_WLAN_REASON_CODE_MSMSEC_BASE +
    NDU_WLAN_REASON_CODE_RANGE_SIZE - 1);
  ...
  NDU_WLAN_REASON_CODE_GP_DENIED = (NDU_WLAN_REASON_CODE_AC_CONNECT_BASE + 3);
  NDU_WLAN_REASON_CODE_USER_DENIED = (NDU_WLAN_REASON_CODE_AC_CONNECT_BASE + 4);
  ...
  NDU_WLAN_REASON_CODE_BSS_TYPE_UNMATCH = (NDU_WLAN_REASON_CODE_MSM_BASE + 3);
  NDU_WLAN_REASON_CODE_PHY_TYPE_UNMATCH = (NDU_WLAN_REASON_CODE_MSM_BASE + 4);
  NDU_WLAN_REASON_CODE_DATARATE_UNMATCH = (NDU_WLAN_REASON_CODE_MSM_BASE + 5);
...
const
  ...
  WLAN_AVAILABLE_NETWORK_CONSOLE_USER_PROFILE = $00000004;

  NDU_WLAN_AVAILABLE_NETWORK_CONNECTED = WLAN_AVAILABLE_NETWORK_CONNECTED;
  NDU_WLAN_AVAILABLE_NETWORK_HAS_PROFILE = WLAN_AVAILABLE_NETWORK_HAS_PROFILE;
  NDU_WLAN_AVAILABLE_NETWORK_CONSOLE_USER_PROFILE =
  ...
  NDU_WLAN_AVAILABLE_NETWORK_INCLUDE_ALL_MANUAL_HIDDEN_PROFILES =
...
type
  ...
  Tndu_WLAN_AVAILABLE_NETWORK = record
    ...
    dot11PhyTypes: array [0 .. WLAN_MAX_PHY_TYPE_NUMBER - 1]
      of Tndu_DOT11_PHY_TYPE;
    bMorePhyTypes: Bool;
    wlanSignalQuality: Tndu_WLAN_SIGNAL_QUALITY;
    bSecurityEnabled: Bool;
    dot11DefaultAuthAlgorithm: Tndu_DOT11_AUTH_ALGORITHM;
...
{$MINENUMSIZE 4}
  ...
  Tndu_WLAN_INTERFACE_STATE = (wlan_interface_state_not_ready = 0,
...
{$MINENUMSIZE 4}
  ...
  Tndu_DOT11_RADIO_STATE = (dot11_radio_state_unknown = 0, dot11_radio_state_on,
...
type
  ...
  Tndu_WLAN_RADIO_STATE = record
    ...
    PhyRadioState: array [0 .. NDU_WLAN_MAX_PHY_INDEX - 1]
      of Tndu_WLAN_PHY_RADIO_STATE;
  end;

{$MINENUMSIZE 4}

  Pndu_WLAN_INTERFACE_TYPE = ^Tndu_WLAN_INTERFACE_TYPE;
  Tndu_WLAN_INTERFACE_TYPE = (wlan_interface_type_emulated_802_11 = 0,
    wlan_interface_type_native_802_11, wlan_interface_type_invalid);
  ...
  Tndu_WLAN_INTERFACE_CAPABILITY = record
    ...
    dot11PhyTypes: array [0 .. NDU_WLAN_MAX_PHY_INDEX - 1]
      of Tndu_DOT11_PHY_TYPE;
  end;
  ...
  Pndu_WLAN_COUNTRY_OR_REGION_STRING_LIST = ^
    Tndu_WLAN_COUNTRY_OR_REGION_STRING_LIST;

  Tndu_WLAN_COUNTRY_OR_REGION_STRING_LIST = record
    pCountryOrRegionStringList: array [0 .. 0]
      of Tndu_DOT11_COUNTRY_OR_REGION_STRING;
  end;
...
{$MINENUMSIZE 4}
  ...
  Tndu_WLAN_POWER_SETTING = (wlan_power_setting_no_saving = 0,
    wlan_power_setting_low_saving, wlan_power_setting_medium_saving,
    wlan_power_setting_maximum_saving, wlan_power_setting_invalid);
...
const
  ...
  NDU_WLAN_NOTIFICATION_SOURCE_SECURITY =
    NDU_L2_NOTIFICATION_SOURCE_WLAN_SECURITY;
...
{$MINENUMSIZE 4}
  ...
  Tndu_WLAN_OPCODE_VALUE_TYPE = (wlan_opcode_value_type_query_only = 0,
    wlan_opcode_value_type_set_by_group_policy,
    wlan_opcode_value_type_set_by_user, wlan_opcode_value_type_invalid);

{$MINENUMSIZE 4}
  Pndu_WLAN_INTF_OPCODE = ^Tndu_WLAN_INTF_OPCODE;
  Tndu_WLAN_INTF_OPCODE = (wlan_intf_opcode_autoconf_start = $000000000,
    wlan_intf_opcode_autoconf_enabled, wlan_intf_opcode_background_scan_enabled,
    ...
    wlan_intf_opcode_msm_start = $10000100, wlan_intf_opcode_statistics,
    wlan_intf_opcode_rssi, wlan_intf_opcode_msm_end = $1FFFFFFF,
...
{$MINENUMSIZE 4}
  ...
  Tndu_WLAN_AUTOCONF_OPCODE = (wlan_autoconf_opcode_start = 0,
...
{$MINENUMSIZE 4}
  ...
  Tndu_WLAN_IHV_CONTROL_TYPE = (wlan_ihv_control_type_service,
    wlan_ihv_control_type_driver);

{$MINENUMSIZE 4}
  Pndu_WLAN_FILTER_LIST_TYPE = ^Tndu_WLAN_FILTER_LIST_TYPE;
  Tndu_WLAN_FILTER_LIST_TYPE = (wlan_filter_list_type_gp_permit,
...
{$MINENUMSIZE 4}
  ...
  Tndu_WLAN_SECURABLE_OBJECT = (wlan_secure_permit_list = 0,
    wlan_secure_deny_list, wlan_secure_ac_enabled, wlan_secure_bc_scan_enabled,
    wlan_secure_bss_type, wlan_secure_show_denied,
    wlan_secure_interface_properties, wlan_secure_ihv_control,
    wlan_secure_all_user_profiles_order, wlan_secure_sso,
    wlan_secure_add_new_all_user_profiles,
    wlan_secure_add_new_per_user_profiles,
    wlan_secure_manual_connect_single_user,
    wlan_secure_manual_connect_multi_user,
    wlan_secure_media_streaming_mode_enabled, NDU_WLAN_SECURABLE_OBJECT_COUNT);
...
function WlanCloseHandle(hClientHandle: Handle; pReserved: PVOID)
  : DWORD; stdcall;

function WlanEnumInterfaces(hClientHandle: Handle; pReserved: PVOID;
  ppInterfaceList: PPndu_WLAN_INTERFACE_INFO_LIST): DWORD; stdcall;

function WlanSetAutoConfigParameter(hClientHandle: Handle;
  OpCode: Tndu_WLAN_AUTOCONF_OPCODE; dwDataSize: DWORD; const pData: PVOID;
  pReserved: PVOID): DWORD; stdcall;

function WlanQueryAutoConfigParameter(hClientHandle: Handle;
  OpCode: Tndu_WLAN_AUTOCONF_OPCODE; pReserved: PVOID; pdwDataSize: PDWORD;
  ppData: PPVOID; pWlanOpcodeValueType: Pndu_WLAN_OPCODE_VALUE_TYPE)
  : DWORD; stdcall;
...
function WlanSetInterface(hClientHandle: Handle; const pInterfaceGuid: PGUID;
  OpCode: Tndu_WLAN_INTF_OPCODE; dwDataSize: DWORD; const pData: PVOID;
  pReserved: PVOID): DWORD; stdcall;

function WlanQueryInterface(hClientHandle: Handle; const pInterfaceGuid: PGUID;
  OpCode: Tndu_WLAN_INTF_OPCODE; pReserved: PVOID; pdwDataSize: PDWORD;
  ppData: PPVOID; pWlanOpcodeValueType: Pndu_WLAN_OPCODE_VALUE_TYPE)
  : DWORD; stdcall;

function WlanIhvControl(hClientHandle: Handle; const pInterfaceGuid: PGUID;
  aType: Tndu_WLAN_IHV_CONTROL_TYPE; dwInBufferSize: DWORD; pInBuffer: PVOID;
  dwOutBufferSize: DWORD; pOutBuffer: PVOID): DWORD; stdcall;

function WlanScan(hClientHandle: Handle; const pInterfaceGuid: PGUID;
  const pDot11Ssid: Pndu_DOT11_SSID; const pIeData: Pndu_WLAN_RAW_DATA;
  pReserved: PVOID): DWORD; stdcall;
...
function WlanGetNetworkBssList(hClientHandle: Handle;
  ...
  dot11BssType: Tndu_DOT11_BSS_TYPE; bSecurityEnabled: Bool; pReserved: PVOID;
  ppWlanBssList: PPndu_WLAN_BSS_LIST): DWORD; stdcall;
...
function WlanDisconnect(hClientHandle: Handle; const pInterfaceGuid: PGUID;
  pReserved: PVOID): DWORD; stdcall;

function WlanRegisterNotification(hClientHandle: Handle; dwNotifSource: DWORD;
  bIgnoreDuplicate: Bool; funcCallback: Tndu_WLAN_NOTIFICATION_CALLBACK;
  pCallbackContext: PVOID; pReserved: PVOID; pdwPrevNotifSource: PDWORD)
  : DWORD; stdcall;

function WlanGetProfile(hClientHandle: Handle; const pInterfaceGuid: PGUID;
  strProfileName: LPCWSTR; pReserved: PVOID; pstrProfileXml: LPWSTR;
...
function WlanSetProfileEapXMLUserData(hClientHandle: Handle;
  const pInterfaceGuid: PGUID; strProfileName: LPCWSTR;
  eapType: Tndu_EAP_METHOD_TYPE; dwFlags: DWORD; strEapXMLUserData: LPCWSTR;
  pReserved: PVOID): DWORD; stdcall;

function WlanSetProfile(hClientHandle: Handle; const pInterfaceGuid: PGUID;
  dwFlags: DWORD; strProfileXml: LPCWSTR; strAllUserProfileSecurity: LPCWSTR;
  bOverwrite: Bool; pReserved: PVOID; pdwReasonCode: PDWORD): DWORD; stdcall;

function WlanDeleteProfile(hClientHandle: Handle; const pInterfaceGuid: PGUID;
  strProfileName: LPCWSTR; pReserved: PVOID): DWORD; stdcall;

function WlanRenameProfile(hClientHandle: Handle; const pInterfaceGuid: PGUID;
  strOldProfileName: LPCWSTR; strNewProfileName: LPCWSTR; pReserved: PVOID)
  : DWORD; stdcall;

function WlanGetProfileList(hClientHandle: Handle; const pInterfaceGuid: PGUID;
  pReserved: PVOID; ppProfileList: PPndu_WLAN_PROFILE_INFO_LIST)
  : DWORD; stdcall;

function WlanSetProfileList(hClientHandle: Handle; const pInterfaceGuid: PGUID;
  dwItems: DWORD; strProfileNames: LPCWSTR; pReserved: PVOID): DWORD; stdcall;

function WlanSetProfilePosition(hClientHandle: Handle;
  const pInterfaceGuid: PGUID; strProfileName: LPCWSTR; dwPosition: DWORD;
  pReserved: PVOID): DWORD; stdcall;

function WlanSetProfileCustomUserData(hClientHandle: Handle;
  const pInterfaceGuid: PGUID; strProfileName: LPCWSTR; dwDataSize: DWORD;
  const pData: LPByte; pReserved: PVOID): DWORD; stdcall;

function WlanGetProfileCustomUserData(hClientHandle: Handle;
  const pInterfaceGuid: PGUID; strProfileName: LPCWSTR; pReserved: PVOID;
  pdwDataSize: PDWORD; ppData: PPByte): DWORD; stdcall;

function WlanSetFilterList(hClientHandle: Handle;
  wlanFilterListType: Tndu_WLAN_FILTER_LIST_TYPE;
  const pNetworkList: Pndu_DOT11_NETWORK_LIST; pReserved: PVOID)
  : DWORD; stdcall;

function WlanGetFilterList(hClientHandle: Handle;
  wlanFilterListType: Tndu_WLAN_FILTER_LIST_TYPE; pReserved: PVOID;
  ppNetworkList: PPndu_DOT11_NETWORK_LIST): DWORD; stdcall;

function WlanSetPsdIEDataList(hClientHandle: Handle; strFormat: LPCWSTR;
  const pPsdIEDataList: Pndu_WLAN_RAW_DATA_LIST; pReserved: PVOID)
  : DWORD; stdcall;

function WlanSaveTemporaryProfile(hClientHandle: Handle;
  const pInterfaceGuid: PGUID; strProfileName: LPCWSTR;
  strAllUserProfileSecurity: LPCWSTR; dwFlags: DWORD; bOverwrite: Bool;
  pReserved: PVOID): DWORD; stdcall;

function WlanExtractPsdIEDataList(hClientHandle: Handle; dwIeDataSize: DWORD;
  const pRawIeData: PByte; strFormat: LPCWSTR; pReserved: PVOID;
  ppPsdIEDataList: PPndu_WLAN_RAW_DATA_LIST): DWORD; stdcall;

function WlanReasonCodeToString(dwReasonCode: DWORD; dwBufferSize: DWORD;
  pStringBuffer: PWChar; pReserved: PVOID): DWORD; stdcall;
...
function WlanSetSecuritySettings(hClientHandle: Handle;
  SecurableObject: Tndu_WLAN_SECURABLE_OBJECT; strModifiedSDDL: LPCWSTR)
  : DWORD; stdcall;

function WlanGetSecuritySettings(hClientHandle: Handle;
  SecurableObject: Tndu_WLAN_SECURABLE_OBJECT; pstrCurrentSDDL: PLPWSTR;
  pdwGrantedAccess: PWord): DWORD; stdcall;
...
type
  ...
  Tndu_WL_DISPLAY_PAGES = (WLConnectionPage, WLSecurityPage);

function WlanUIEditProfile(dwClientVersion: DWORD; wstrProfileName: LPCWSTR;
  pInterfaceGuid: PGUID; phWnd: hWnd; wlStartPage: Tndu_WL_DISPLAY_PAGES;
...
function WlanSetAutoConfigParameter;
  external wlan_api_dll name 'WlanSetAutoConfigParameter';
function WlanQueryAutoConfigParameter;
  external wlan_api_dll name 'WlanQueryAutoConfigParameter';
function WlanGetInterfaceCapability;
  external wlan_api_dll name 'WlanGetInterfaceCapability';
...
function WlanGetAvailableNetworkList;
  external wlan_api_dll name 'WlanGetAvailableNetworkList';
function WlanGetNetworkBssList;
  external wlan_api_dll name 'WlanGetNetworkBssList';
...
function WlanRegisterNotification;
  external wlan_api_dll name 'WlanRegisterNotification';
function WlanGetProfile; external wlan_api_dll name 'WlanGetProfile';
function WlanSetProfileEapUserData;
  external wlan_api_dll name 'WlanSetProfileEapUserData';
function WlanSetProfileEapXMLUserData;
  external wlan_api_dll name 'WlanSetProfileEapXMLUserData';
...
function WlanSetProfilePosition;
  external wlan_api_dll name 'WlanSetProfilePosition';
function WlanSetProfileCustomUserData;
  external wlan_api_dll name 'WlanSetProfileCustomUserData';
function WlanGetProfileCustomUserData;
  external wlan_api_dll name 'WlanGetProfileCustomUserData';
...
function WlanSetPsdIEDataList;
  external wlan_api_dll name 'WlanSetPsdIEDataList';
function WlanSaveTemporaryProfile;
  external wlan_api_dll name 'WlanSaveTemporaryProfile';
function WlanExtractPsdIEDataList;
  external wlan_api_dll name 'WlanExtractPsdIEDataList';
function WlanReasonCodeToString;
  external wlan_api_dll name 'WlanReasonCodeToString';
...
function WlanSetSecuritySettings;
  external wlan_api_dll name 'WlanSetSecuritySettings';
